  ...
  switch (node.constructor) {
    ...
    case ast.IfStatement:
      return {
        ...
        consequent: statementify(this.convert(node.left)),
        alternate: node.right && statementify(this.convert(node.right))
      };

    case ast.BlockStatement:
      return {
        type: 'BlockStatement',
        body: node.body.map(this.convert, this).map(statementify)
      };
